...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/deploy/yolov7x1.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/mydata_test.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch.p5.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=450)
    parser.add_argument('--batch-size', type=int, default=4, help='total batch size for all GPUs')
    parser.add_argument('--img-size', nargs='+', type=int, default=[640, 640], help='[train, test] image sizes')
    parser.add_argument('--rect', action='store_true', help='rectangular training')
    parser.add_argument('--resume', nargs='?', const=True, default=True, help='resume most recent training')  # 断点续练
...
'''
断点训练
Usage: python train_resume.py --weights ./runs/train/exp/weights/last.pt
'''
